...
def retrieve_data_cfg(config_path, skip_type, cfg_options):
    ...
    train_data_cfg = cfg.data.scannetv2_labels_table
...
def main():
    ...
    if 'gt_semantic_seg' in cfg.train_pipeline[-1]['keys']:
        cfg.data.scannetv2_labels_table.pipeline = [
            p for p in cfg.data.scannetv2_labels_table.pipeline if p['type'] != 'SegRescale'
        ]
    dataset = build_dataset(cfg.data.scannetv2_labels_table)
