...
class Model(torch.nn.Module):
    ...
    def image_encoding(self, batch_image_patches):
        ...
        Args:
            batch_image_patches: shape=(batch,n,512)

        Returns:
            batch_image_feature: shape=(batch,20,512) dim=clip提取的特征维度
