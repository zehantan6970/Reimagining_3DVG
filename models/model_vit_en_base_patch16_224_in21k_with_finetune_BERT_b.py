...
class Model(torch.nn.Module):
    def __init__(self, args):
        ...
        self.line1 = LineNormLayers(756, 384)
        self.line2 = LineNormLayers(756, 384)
        self.line3 = LineNormLayers(756, 384)
    ...
    def forward(self, batch_image_patches, d3_patches, question):
        ...
        tgt_embedding = torch.as_tensor(torch.unsqueeze(tgt_embedding, dim=1).detach().cpu().numpy(), dtype=torch.float32).to(
            device)
